...
class SettingsView(QWidget):
    ...
    def _init_ui(self):
        ...
        # Scroll area for settings dashboard
        scroll = QScrollArea()
        ...
        self.settings_dashboard = DictaPilotDashboard()
        scroll.setWidget(self.settings_dashboard)
    ...
    def _create_search_bar(self) -> QFrame:
        ...
        bar.setStyleSheet(
            f"background-color: {self.theme_manager.get_color('bg-base')};"
        )
    ...
    def _create_unsaved_bar(self) -> QFrame:
        ...
        message.setStyleSheet(
            f"color: {self.theme_manager.get_color('text-primary')}; font-weight: 600;"
        )
