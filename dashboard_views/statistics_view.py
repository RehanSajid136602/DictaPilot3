...
from PySide6.QtWidgets import (
    ...
    QLabel, QPushButton, QButtonGroup, QFrame, QTableWidget,
...
from dashboard_components.charts import LineChartWidget, BarChartWidget, DonutChartWidget
from transcription_store import (
    get_transcription_count_by_date, get_total_word_count,
    get_average_wpm, get_quality_distribution, get_transcriptions_by_day,
    get_store
)
